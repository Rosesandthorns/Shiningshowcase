...
export function Dashboard() {
    ...
    useEffect(() => {
        ...
        const setupFollowingListener = async () => {
            ...
            // Step 1: Listen to the following collection for changes
            ...
            unsubFollowing = onSnapshot(followingQuery, async (followingSnapshot) => {
                ...
                // Step 2: For each followed user, listen to their pokemonShards for real-time updates
                ...
                for (const followedUser of followedUsers) {
                    ...
                    const unsubShard = onSnapshot(shardsQuery, (shardSnapshot) => {
                        ...
                        // Iterate through all shards for this user
                        for (const shardDoc of shardSnapshot.docs) {
                            const shardData = shardDoc.data();
                            const pokemonMap = shardData. pokemonMap || {};

                            // Find the most recent pokemon in this shard
                        ...
                        // Update the overall latest pokemon across all followed users
                        if (latestPokemonFromThisUser) {
                            if (! allLatestPokemon || 
