...
export const userPokemonData: UserPokemon[] = [
  ...
  { nickname: "Poke", species: "#0025 - Pikachu", description: "Caught in PLA", imageUrl: "https://via.placeholder.com/200x200.png", tags: ["Electric", "PLA"], level: "62", nature: "Lonely", moveset: ["Spark", "Thunderbolt", "Iron Tail", "Thunder"], ability: "None" },
  ...
  { nickname: "Qwil", species: "#0211 - Qwilfish-hisui", description: "Placeholder", imageUrl: "https://via.placeholder.com/200x200.png", tags: ["Dark", "Poison", "PLA"], level: "?", nature: "?", moveset: [] },
  { nickname: "Qwilly", species: "#0211 - Qwilfish-hisui", description: "Placeholder", imageUrl: "https://via.placeholder.com/200x200.png", tags: ["Dark", "Poison", "PLA"], level: "?", nature: "?", moveset: [] },
