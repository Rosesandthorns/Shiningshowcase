...
export const userPokemonData: UserPokemon[] = [
  ...
  { nickname: "Poke", species: "#0025 - Pikachu", description: "Caught in PLA", imageUrl: "https://via.placeholder.com/200x200.png", tags: ["Electric", "PLA"], level: "?", nature: "Lonely", moveset: ["Spark", "Thunderbolt", "Iron Tail", "Thunder"] },
