...
export const userPokemonData: UserPokemon[] = [
  ...
  { nickname: "Nightsky", species: "#0037 - Vulpix-alola", description: "Caught in the snowy mountains of Paldea.", imageUrl: "https://via.placeholder.com/200x200.png", tags: ["Ice", "SV"], level: "64", nature: "Impish", moveset: ["Ice Fang", "Dazzling Gleam", "Ice Beam", "Blizzard"], ability: "Snow Cloak" },
