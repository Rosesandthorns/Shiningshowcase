...
export const userPokemonData: UserPokemon[] = [
  ...
  { nickname: "Butterscotch", species: "#0026 - Alolan Raichu", description: "This pancake-tailed mouse was caught in Sword and Shield and helped win the Galar Champion cup!", imageUrl: "https://cdn.shopify.com/s/files/1/1732/7223/files/poke_capture_0026_001_mf_n_00000000_f_r_medium.png?v=1701796360", tags: ["Electric", "Psychic", "SWSh", "Galar Champion"], level: "?", nature: "Mild", moveset: ["Thunderbolt", "Electric Terrain", "Psychic", "Round"] },
