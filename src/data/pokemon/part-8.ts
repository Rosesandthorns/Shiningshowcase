...
export const userPokemonData: UserPokemon[] = [
  ...
  { nickname: "Lime", species: "#0027 - Sandshrew", description: "Placeholder", imageUrl: "https://www.serebii.net/Shiny/SV/new/027.png", tags: ["Ground", "SV"], level: "60", nature: "Gentle", moveset: ["Gyro Ball", "Swords Dance", "Sandstorm", "Earthquake"], ability: "Sand Veil" },
